...
export const GenericRound = ({
  ...
  return <div className="min-h-screen qlaf-bg flex flex-col p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="flex-1 items-center justify-center flex flex-row">
        ...
        delay: 0.1
      }} className="glass-card rounded-2xl p-6 md:p-8 max-w-4xl w-full text-center px-[16px] pt-[8px] pb-[16px]">
          {currentQuestion ? <>
              {/* Question number */}
              <div className="mb-4">
            ...
            scale: 1
                  ...
                  {Array.isArray(currentQuestion.answer) ? currentQuestion.answer.length > 10 ? <div className="mt-2 max-h-48 overflow-y-auto">
